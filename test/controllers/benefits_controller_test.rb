...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post benefits_url, params: { benefit: { benefit_category_id: @benefit.benefit_category_id, description: @benefit.description, from: @benefit.from, name: @benefit.name, to: @benefit.to } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { benefit_category_id: @benefit.benefit_category_id, description: @benefit.description, from: @benefit.from, name: @benefit.name, to: @benefit.to } }
